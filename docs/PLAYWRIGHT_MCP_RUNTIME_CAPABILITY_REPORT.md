...
The path resolved on the Windows host to:
    ...
    DownloadDirectory=C:\Users\<user>\Desktop\HUNNU-Research-Harness-Output\staging\playwright-output
...
The Harness venv Python runtime read the same file:
    ...
    HarnessPython=C:\Users\<user>\Desktop\HUNNU-Research-Harness\.venv\Scripts\python.exe
